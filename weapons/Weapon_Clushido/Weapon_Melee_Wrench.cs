//audio
datablock AudioProfile(meleeWrenchHit1Sound)
{
   filename    = "./melee_blunt.wav";
   description = AudioClose3d;
   preload = true;
};
datablock AudioProfile(meleeWrenchHit2Sound)
{
...
datablock ItemData(meleeWrenchItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./Monkey_Wrench.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	...
	iconName = "./icon_meleeWrench";
	doColorShift = false;
	colorShiftColor = "0.100 0.500 0.250 1.000";

	 // Dynamic properties defined by the scripts
	image = meleeWrenchImage;
	canDrop = true;
};
...
datablock ShapeBaseImageData(meleeWrenchImage)
{
   // Basic Item properties
   shapeFile = "./Monkey_Wrench.dts";
   emap = true;
   ...
   raycastExplosionPlayerSound = meleeWrenchHit2Sound;
   raycastExplosionBrickSound = meleeWrenchHit1Sound;
   ...
   // Projectile && Ammo.
   item = meleeWrenchItem;
   ammo = " ";
   projectile = meleeWrenchProjectile;
   ...
   doColorShift = false;
   colorShiftColor = meleeWrenchItem.colorShiftColor;//"0.400 0.196 0 1.000";
...
function meleeWrenchImage::onAim(%this,%obj,%slot)
{
	%obj.playThread(1,ArmReadyRight);
}

function meleeWrenchImage::onDrop(%this,%obj,%slot)
{
	%obj.playThread(1,root);
}

function meleeWrenchImage::onFire(%this,%obj,%slot)
{
	Parent::onFire(%this, %obj, %slot);
	%obj.playThread(2,shiftto);
}

function meleeWrenchImage::onFireDown(%this,%obj,%slot)
{
