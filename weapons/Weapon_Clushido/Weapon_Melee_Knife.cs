//audio
datablock AudioProfile(meleeKnifeHit1Sound)
{
   filename    = "./melee_knife_01.wav";
   description = AudioClose3d;
   preload = true;
};
datablock AudioProfile(meleeKnifeHit2Sound)
{
...
datablock ItemData(meleeKnifeItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./chef_knife.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
...
datablock ShapeBaseImageData(meleeKnifeImage)
{
   // Basic Item properties
   shapeFile = "./chef_knife.dts";
   emap = true;
   ...
   raycastExplosionPlayerSound = meleeKnifeHit2Sound;
   raycastExplosionBrickSound = meleeKnifeHit1Sound;
   ...
   item = meleeKnifeItem;
   ammo = " ";
   projectile = meleeKnifeProjectile;
   ...
   doColorShift = false;
   colorShiftColor = meleeKnifeItem.colorShiftColor;//"0.400 0.196 0 1.000";
   ...
   // Initial start up state
	...
	stateSound[3]			= meleeKnifeSwingSound;
...
function meleeKnifeImage::onAim(%this,%obj,%slot)
{
	%obj.playThread(1,ArmReadyRight);
}

function meleeKnifeImage::onDrop(%this,%obj,%slot)
{
	%obj.playThread(1,root);
}

function meleeKnifeImage::onFire(%this,%obj,%slot)
{
...
function meleeKnifeImage::onFireDown(%this,%obj,%slot)
{
